...
public class EditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        displayStartDateTextView.setText(selectedAssignment.getStartDate());
        displayStartTimeTextView.setText(selectedAssignment.getStartTime());
        displayEndDateTextView.setText(selectedAssignment.getEndDate());
        displayEndTimeTextView.setText(selectedAssignment.getEndTime());

        AdapterCreateQuiz adapterCreateQuiz = new AdapterCreateQuiz(selectedAssignment.getQuestions());
        ...
        btn1.setOnClickListener(view -> {
            ...
            if (course.isEmpty() || youtube.isEmpty() || level.isEmpty() || startDate.isEmpty() ||startTime.isEmpty() ||endDate.isEmpty() ||endTime.isEmpty()) {
                Toast.makeText(EditActivity.this, "Please enter complete information.", Toast.LENGTH_SHORT).show();
            } else {
                // Lưu dữ liệu vào Firestore

                updateDataInFirestore(course, youtube, level, startDate, startTime,endDate,endTime);
            }
        });
...
//    }
    ...
    private void updateDataInFirestore(String course, String youtube, String level, String startDate, String startTime, String endDate, String endTime) {
        // Lấy ID của người dùng hiện tại từ Firebase Authentication
        String userId = userDocument.getId();
        Timestamp timestamp = new Timestamp(System.currentTimeMillis());

        selectedAssignment.setStartTime(startTime);
        selectedAssignment.setEndTime(endTime);
